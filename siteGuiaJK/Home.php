...
<form  method="post" action="Home.php" style="display: inline;">
        <div><p id="pf"><a href="TelaEditar.php">Editar conta</a></p></div>
        <div><button id="btnSair" type="submit" name="sair" value="sair">Sair da conta</button></div>
        <div onclick="abrirModal()" class="btn"><button>Excluir conta</buttom></div>
        </form>
